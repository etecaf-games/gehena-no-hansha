    ...
    void BuildDatabase()
    {
        items = new List<Item>() {
            new Item(0, "Canivete", "Uma lâmina pequena, mas afiada! Cuidado! Pode acabar furando um olho!",
                new Dictionary<string, int> {{ "Ataque", 1 }
                }),
            ...
            new Item(4,"Taco", "As pessoas dizem que baseball não é um esporte violente. Mas você com um taco de baseball? Ai é outra história.",
               ...
               new Item(7,"Microfone de Ária", "Todo rosa, até meio infantil. Aparentemente, Ária usava apenas este microfone, um presente de sua avó. Ela dizia que a ajudava a superar a timidez.",
                   new Dictionary<string, int>{
                       {"Memento Ária", 1},
                   }),
